...
public class InterUsuario extends javax.swing.JInternalFrame {
    ...
    public InterUsuario() {
        initComponents();
        this.setSize(new Dimension(410, 331));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 90, 30));
        ...
        getContentPane().add(txt_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 200, 170, -1));

        Administrador.setText("ADMINISTRADOR");
        getContentPane().add(Administrador, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, -1, -1));

        jLabel_wallpaper.setBackground(new java.awt.Color(255, 51, 51));
        ...
        getContentPane().add(jLabel_wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 420, 300));

        txt_telefono1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        getContentPane().add(txt_telefono1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 170, -1));
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        if (txt_nombre.getText().isEmpty() || txt_apellido.getText().isEmpty() || txt_cedula.getText().isEmpty()
                || txt_password.getText().isEmpty() || txt_telefono.getText().isEmpty() || txt_direccion.getText().isEmpty()) {
